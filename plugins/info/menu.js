...
let handler = async (m, {
    ...
    let arrayMenu = ['anonymous', 'main', 'fun', 'islami', 'info', 'ai', 'bug', 'jadibot', 'quotes', 'store', 'ephoto', 'downloader', 'textprome', 'nsfw', 'convert', 'premium', 'music', 'maker', 'game', 'group', 'panel', 'internet', 'hengker', 'owner', 'rpg', 'saluran', 'sticker', 'tools', 'anime', 'convert']
